...
urlpatterns = [
    ...
    path("signup-volunteer/", views.signup_volunter.as_view(), name="signup_volunteer"),
    ...
    path('delete/<str:pk>',views.delete_donation, name='delete_donations'),
    path('delete-volunter/<str:pk>',views.delete_volunteer, name='delete_volunteer'),
    ...
    path("manage-area/", views.manage_area, name="manage_area"),
     path('changepwd-admin/', views.changepwd_admin, name='changepwd_admin'),  # For logged-in user
    path('changepwd-admin/<int:user_id>/', views.changepwd_admin, name='changepwd_admin_with_user'), 
